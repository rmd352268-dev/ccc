...
<body>
    ...
    <!-- 💬 Floating 24/7 Live Telegram Support Bot Button -->
    <a href="https://t.me/PayateSupport_Bot" target="_blank" id="tg-support-floating" style="position: fixed; bottom: 22px; right: 22px; z-index: 999; display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, #0284C7, #0369A1); color: #FFF; text-decoration: none; padding: 10px 16px; border-radius: 9999px; font-size: 13px; font-weight: 800; box-shadow: 0 6px 20px rgba(2, 132, 199, 0.45); border: 1.5px solid rgba(56, 189, 248, 0.5); transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1);" onmouseover="this.style.transform='translateY(-3px) scale(1.03)'; this.style.boxShadow='0 8px 25px rgba(2, 132, 199, 0.6)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 6px 20px rgba(2, 132, 199, 0.45)';" title="Chat with 24/7 Live Support on Telegram">
        <i class="fa-brands fa-telegram" style="font-size: 18px; color: #38BDF8;"></i>
